package com.nisarga.nisargaveggiez.Home3;
...
import com.nisarga.nisargaveggiez.retrofit.MultipleResources;
        ...
        if(Utils.CheckInternetConnection(getApplicationContext()))
        {
            ...
            call.enqueue(new Callback<MultipleResources>() {
                ...
                public void onResponse(Call<MultipleResources> call, Response<MultipleResources> response) {
                    ...
                    for (MultipleResources.categories category : datumList) {
